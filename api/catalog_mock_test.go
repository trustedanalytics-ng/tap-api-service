...
import (
	...
	http "github.com/trustedanalytics-ng/tap-go-common/http"
)
...
func (_m *MockTapCatalogApi) ListApplications(filter *http.ItemFilter) ([]models.Application, int, error) {
	ret := _m.ctrl.Call(_m, "ListApplications", filter)
	ret0, _ := ret[0].([]models.Application)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (_mr *_MockTapCatalogApiRecorder) ListApplications(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ListApplications", arg0)
}
